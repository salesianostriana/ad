...
/*
 * Ampliación 2. Generación de primos almacenados como tipo long
 * 
 * Basándonos en el ejercicio AMPLI1, implementar una aplicación que en lugar de 
 * guardar los N primeros números en un fichero, almacene los N primeros números primos, 
 * pero como tipo de dato long
 * 
 *  
 * Salesianos Triana
...
public class T1S02_AMPLI2 {
	...
	public static void main(String[] args) {
		...
		if (args.length != 2) {
			System.err
					.println("Sintaxis erronea: java T1S021_AMPLI2_ImprimirPrimerosNumerosPrimos <nombre_fichero> <N>");
		} else {
